  ...
  /*  public static boolean checkRegistration(int id, String name, String type) {
    ...
    public  void suspendMember (int memberID) {
        ...
        if (memberFound) {
            ...
            if (!suspensionFound) {
            ...
            } else if (eS.getMemberID() == memberID && eS.getSuspensions() < 3) {
                ...
                if (ban(getMemberById(memberID))) {
                    System.out.println("User has been banned due to misconduct.");
                }
            } else {
                System.out.println("Member was not found and can't be suspended.");
            }
        }
    }
